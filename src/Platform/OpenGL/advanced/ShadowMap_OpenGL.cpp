...
void OpenGL::Advanced::ShadowMap_OpenGL::BindAndClear()
{
...
unsigned int OpenGL::Advanced::ShadowMap_OpenGL::BindDepthTexture(const unsigned int slot)
{
...
void OpenGL::Advanced::ShadowMap_OpenGL::UnbindDepthTexture()
{
